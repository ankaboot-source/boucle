...
| Template | Purpose |
|---|---|
| `templates/triage.md` | Triage comment (marker + TL;DR, Analysis, Acceptance criteria, Questions, and one `## Metadata` section: impacts, impacted files, size, validation, disposition) |
